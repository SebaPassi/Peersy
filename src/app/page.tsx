    ...
    <div className="min-h-screen bg-pattern">
      ...
      <main className="container mx-auto px-6 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-xl text-purple-400">The University of Manchester</h1>
          {/* Main Headline */}
      ...
      <footer className="container mx-auto px-6 py-16 border-t border-gray-800">
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
          ...
          <div className="text-white font-semibold text-sm md:text-base">
            MANCHESTER
            <br />
            <span className="text-xs md:text-sm font-normal">1824 The University of Manchester</span>
          </div>
